  ...
  return (
    <html lang="en">
      <body className={inter.className}>
          <>
      {/* ========== HEADER ========== */}
      <header className="w-full sticky top-0 inset-x-0 flex flex-wrap md:justify-start md:flex-nowrap z-50 text-sm">
      ...
      {/* ========== END HEADER ========== */}
        ...
        <>
  {/* ========== FOOTER ========== */}
  <footer className="mt-auto w-full max-w-[85rem] py-10 px-4 sm:px-6 lg:px-8 mx-auto mt-10">
    {/* Grid */}
